...
|Questão|Resposta|
|-------|--------|
|What? |Um aplicativo web ou para facilitar a comunicação e acesso aos serviços publicos.
|Why? |Para auxiliar com as condições de vida dos moradores da Ilha primeira.
|Where? |O trabalho sera realizado na Ilha primeira
|When? |Durante o primeiro semestre de 2025
|Who? |A equipe é formada pelos alunos Enrique, Pedro de Castro Kurtz, Jeronimo Chiclana, Julia Siodaro.
